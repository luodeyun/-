  ...
  <div class="rt-sing" ref="tablell">
    <div class="sing-title">
      ...
      <TitleBox
        :titles="titleTwo"
        name="分类"
        @changeClass="changeTwo"
      ></TitleBox>
      <TitleBox
        :titles="titleThree"
        name="筛选"
        @changeClass="changeThree"
      ></TitleBox>
      <div class="singers">
        <SingerCard
          v-for="(item, index) in singerAll"
          :key="index"
          :cards="item"
        ></SingerCard>
      </div>
...
import TitleBox from "@/components/singerlist/TitleBox";
import SingerCard from "@/components/singerlist/SingerCard";
export default {
  name: "RightSinger",
  components: {
    TitleBox,
